...
const expectedTablesBySchema = {
  channel: [
    ...
    'channel_recharge_records',
    'channel_request_nonces',
    'channel_split_policies',
    'channels',
    'portal_login_logs',
    'portal_login_sessions',
  ],
  iam: [
    'admin_users',
    'login_logs',
  ...
  ordering: ['order_events', 'order_groups', 'orders'],
  product: [
    'mobile_segments',
  ...
  worker: ['worker_dead_letters', 'worker_job_artifacts', 'worker_job_attempts', 'worker_job_items', 'worker_jobs'],
