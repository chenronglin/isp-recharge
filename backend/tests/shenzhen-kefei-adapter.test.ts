...
describe('shenzhen kefei protocol primitives', () => {
  ...
  test('decodeKefeiResponse decodes GBK response bytes', () => {
    const gbkResponse = Buffer.from([
      0x7b, 0x22, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x43, 0x6f, 0x64, 0x65, 0x22, 0x3a, 0x31, 0x2c, 0x22,
      0x65, 0x72, 0x72, 0x6f, 0x72, 0x44, 0x65, 0x73, 0x63, 0x22, 0x3a, 0x22, 0xb2, 0xd9, 0xd7, 0xf7,
      0xb3, 0xc9, 0xb9, 0xa6, 0x22, 0x7d,
    ]);
